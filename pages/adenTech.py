...
components.html(
    ...
    ">
        ...
        ">
            <span style="background:#ec4899;color:white;padding:10px 22px;border-radius:30px;font-weight:800;">Multi-Agent</span>
            <span style="background:#8b5cf6;color:white;padding:10px 22px;border-radius:30px;font-weight:800;">Real-Time</span>
        ...
        <p style="
            ...
            font-weight: 600;
        ">
            Built for <strong style="color:white;">Aden Technologies</strong>
