# 🧪 Decipher AI — Automated Test Generation
...
- Automatic coverage estimation (60–98%)
- Line, branch, and function coverage breakdowns

**Example:**  
Paste a Python function → AI analyzes logic → generates 10–15 tests → achieves ~90% coverage in <2 seconds

---

## Why It Matters

**Problem:** Writing tests is slow, boring, and often skipped  
**Solution:** AI-generated tests that are fast, thorough, and production-ready
...
Python • LLMs • Pytest • Gradio • Software Quality Analytics
...
Built with 🧪 + 🤖 to make testing painless