...
.hero {
    ...
    padding: 70px 50px; border-radius: 20px; margin-bottom: 50px;
...
.hero-content { position: relative; z-index: 1; display: flex; align-items: center; gap: 30px; }
.logo-container { flex-shrink: 0; }
.logo-container img { width: 120px; height: 120px; filter: brightness(0) invert(1); opacity: 0.95; }
.hero-text { flex: 1; }
.hero h1 { color: white; font-size: 52px; font-weight: 800; margin: 0 0 20px 0; letter-spacing: -1px; line-height: 1.2; }
.hero p { color: rgba(255,255,255,0.9); font-size: 20px; line-height: 1.6; max-width: 800px; }
.content-section { background: white; border-radius: 16px; padding: 40px; margin-bottom: 35px; border-left: 5px solid #73BA9B; }
.content-section h2 { font-size: 28px; font-weight: 700; color: #1f2937; margin: 0 0 20px 0; }
.content-section h3 { font-size: 20px; font-weight: 600; color: #374151; margin: 25px 0 15px 0; }
.content-section p { font-size: 17px; line-height: 1.7; color: #4b5563; margin: 0 0 15px 0; }
.content-section ul { font-size: 17px; line-height: 1.8; color: #4b5563; }
.highlight-box { background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-left: 4px solid #73BA9B; padding: 25px; border-radius: 12px; margin: 25px 0; }
.highlight-box h3 { color: #065f46; margin: 0 0 15px 0; font-size: 20px; font-weight: 700; }
.highlight-box p { color: #047857; margin: 0; font-size: 16px; line-height: 1.6; }
.demo-showcase { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 30px 0; }
.demo-card { background: #f8fafc; border-radius: 12px; padding: 25px; border-left: 4px solid #73BA9B; }
.demo-card h4 { font-size: 18px; font-weight: 700; color: #1e293b; margin: 0 0 10px 0; }
.demo-card p { font-size: 15px; color: #64748b; margin: 0; line-height: 1.6; }
.tech-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 25px 0; }
.tech-item { background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0; }
.tech-item h4 { font-size: 16px; font-weight: 600; color: #1e293b; margin: 0 0 10px 0; }
.tech-item p { font-size: 14px; color: #64748b; margin: 0; line-height: 1.5; }
.contact-box { background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 16px; padding: 40px; text-align: center; margin: 50px 0 30px 0; }
.contact-links { display: flex; gap: 15px; justify-content: center; margin-top: 25px; flex-wrap: wrap; }
.contact-link { background: #73BA9B; color: white; padding: 12px 28px; border-radius: 10px; text-decoration: none; font-weight: 600; font-size: 15px; transition: all 0.2s ease; display: inline-block; }
.contact-link:hover { background: #5fa385; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(115, 186, 155, 0.3); }
...
<div class="content-section">
    ...
    <div class="demo-showcase">
        ...
        <div class="demo-card">
            <h4>🔬 LayerLens - Clinical Chart Abstractor</h4>
            <p>
                Claude-powered extraction of structured fields from free-text clinical notes.
                Every extracted value is linked back to its exact source span, highlighted in the original note with a confidence score.
            </p>
        </div>
        <div class="demo-card">
...
<div class="content-section">
    ...
    <p>I'm looking for full-time ML engineering roles where I can:</p>
    <ul>
