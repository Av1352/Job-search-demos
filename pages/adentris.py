...
# Test header
st.markdown("""
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 50px; border-radius: 25px; text-align: center; color: white;">
    <h1>Adentris Compliance</h1>
    <p>AI Healthcare Compliance Intelligence</p>
</div>
""", unsafe_allow_html=True)
