...
def analyze_sales_call(call_name):
    ...
    return call, overall_score, grade, grade_color, talk_ratio_score, question_score, objection_handling_score, next_steps_score, prospect_engagement, fig_performance
...
with tab1:
    ...
    if st.button("🎯 Analyze Call Performance", type="primary", use_container_width=True):
        ...
        st.session_state.current_call = call_name
    
    if st.session_state.analysis_done:
        call, overall_score, grade, grade_color, talk_ratio_score, question_score, objection_handling_score, next_steps_score, prospect_engagement, fig_performance = analyze_sales_call(st.session_state.current_call)
        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; padding: 32px; box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3); margin-bottom: 25px;">
            <h2 style="color: white; font-size: 32px; font-weight: 900; margin: 0 0 20px 0;">📞 Call Analysis: {st.session_state.current_call}</h2>
        ...
        <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 3px solid #3b82f6; border-radius: 20px; padding: 28px; box-shadow: 0 8px 20px rgba(59, 130, 246, 0.2);">
            ...
            <div style="background: white; border-radius: 12px; padding: 20px; font-family: 'Courier New', monospace; font-size: 13px; line-height: 1.8; color: #1f2937; white-space: pre-wrap;">{call['transcript']}</div>
...
with tab2:
    ...
    if st.session_state.dashboard_loaded:
            ...
            <div style="display: grid; gap: 12px;">
                <div style="background: white; border-left: 5px solid #10b981; border-radius: 12px; padding: 18px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <span style="background: #10b981; color: white; padding: 6px 14px; border-radius: 16px; font-size: 12px; font-weight: 800; margin-right: 10px;">#1</span>
                            <span style="font-size: 18px; color: #1f2937; font-weight: 800;">Sarah Chen</span>
                        </div>
                        <div style="text-align: right;">
                            <p style="font-size: 32px; color: #10b981; font-weight: 900; margin: 0;">94</p>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; margin-top: 12px;">
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            ...
                            <p style="font-size: 18px; color: #1f2937; font-weight: 700; margin: 4px 0 0 0;">47</p>
                        </div>
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            <p style="font-size: 11px; color: #6b7280; margin: 0;">Win Rate</p>
                            <p style="font-size: 18px; color: #10b981; font-weight: 700; margin: 4px 0 0 0;">42%</p>
                        </div>
                    </div>
                </div>
                <div style="background: white; border-left: 5px solid #3b82f6; border-radius: 12px; padding: 18px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <span style="background: #3b82f6; color: white; padding: 6px 14px; border-radius: 16px; font-size: 12px; font-weight: 800; margin-right: 10px;">#2</span>
                            <span style="font-size: 18px; color: #1f2937; font-weight: 800;">Mike Johnson</span>
                        </div>
                        <div style="text-align: right;">
                            <p style="font-size: 32px; color: #3b82f6; font-weight: 900; margin: 0;">89</p>
                            <p style="font-size: 12px; color: #6b7280; margin: 4px 0 0 0;">Avg Score</p>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; margin-top: 12px;">
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            <p style="font-size: 11px; color: #6b7280; margin: 0;">Calls</p>
                            <p style="font-size: 18px; color: #1f2937; font-weight: 700; margin: 4px 0 0 0;">52</p>
                        </div>
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            <p style="font-size: 11px; color: #6b7280; margin: 0;">Win Rate</p>
                            <p style="font-size: 18px; color: #10b981; font-weight: 700; margin: 4px 0 0 0;">38%</p>
                        </div>
                    </div>
                </div>
                <div style="background: white; border-left: 5px solid #8b5cf6; border-radius: 12px; padding: 18px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <span style="background: #8b5cf6; color: white; padding: 6px 14px; border-radius: 16px; font-size: 12px; font-weight: 800; margin-right: 10px;">#3</span>
                            <span style="font-size: 18px; color: #1f2937; font-weight: 800;">Lisa Park</span>
                        </div>
                        <div style="text-align: right;">
                            <p style="font-size: 32px; color: #8b5cf6; font-weight: 900; margin: 0;">87</p>
                            <p style="font-size: 12px; color: #6b7280; margin: 4px 0 0 0;">Avg Score</p>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; margin-top: 12px;">
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            <p style="font-size: 11px; color: #6b7280; margin: 0;">Calls</p>
                            <p style="font-size: 18px; color: #1f2937; font-weight: 700; margin: 4px 0 0 0;">41</p>
                        </div>
                        <div style="background: #f9fafb; border-radius: 8px; padding: 10px; text-align: center;">
                            <p style="font-size: 11px; color: #6b7280; margin: 0;">Win Rate</p>
                            <p style="font-size: 18px; color: #10b981; font-weight: 700; margin: 4px 0 0 0;">35%</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        fig_trends = generate_team_dashboard()
