...
def analyze_startup(startup_name):
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; padding: 32px; box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3); margin-bottom: 25px;">
        <h2 style="color: white; font-size: 32px; font-weight: 900; margin: 0 0 20px 0;">🎯 Investment Analysis: {startup_name}</h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 15px;">
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">AI Score</p>
                <p style="font-size: 48px; color: {rec_color}; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">{avg_score:.0f}</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">{rec_emoji} {recommendation}</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">ARR</p>
                <p style="font-size: 40px; color: white; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">${startup['arr']:.1f}M</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Annual revenue</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Growth Rate</p>
                <p style="font-size: 40px; color: #86efac; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">{startup['growth_rate']}%</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">YoY growth</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Runway</p>
                <p style="font-size: 40px; color: white; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">{startup['runway']}m</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Cash remaining</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Valuation</p>
                <p style="font-size: 40px; color: #fbbf24; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">${startup['valuation']}M</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Post-money</p>
            </div>
        </div>
    </div>
    """
    ...
    <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 3px solid #3b82f6; border-radius: 20px; padding: 28px; box-shadow: 0 8px 20px rgba(59, 130, 246, 0.2); margin-bottom: 25px;">
        <h3 style="color: #1e40af; font-size: 26px; font-weight: 900; margin: 0 0 20px 0;">📊 Key Investment Metrics</h3>
        
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-bottom: 20px;">
            <div style="background: white; border-radius: 14px; padding: 22px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                <h4 style="color: #1f2937; font-size: 16px; font-weight: 800; margin: 0 0 12px 0;">📈 Revenue Multiple</h4>
                <p style="font-size: 36px; color: #3b82f6; font-weight: 900; margin: 0;">{startup['valuation']/startup['arr']:.1f}x</p>
                <p style="font-size: 13px; color: #6b7280; margin: 8px 0 0 0;">Valuation / ARR</p>
                <div style="background: #f0f9ff; border-radius: 8px; padding: 8px; margin-top: 10px;">
                    <p style="font-size: 12px; color: #3b82f6; margin: 0; font-weight: 600;">Market avg: 8-12x for {startup['stage']}</p>
                </div>
            </div>
            
            <div style="background: white; border-radius: 14px; padding: 22px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                <h4 style="color: #1f2937; font-size: 16px; font-weight: 800; margin: 0 0 12px 0;">💰 Capital Efficiency</h4>
                <p style="font-size: 36px; color: #10b981; font-weight: 900; margin: 0;">{magic_number:.2f}</p>
                <p style="font-size: 13px; color: #6b7280; margin: 8px 0 0 0;">Magic Number (ARR/Raise)</p>
                <div style="background: #d1fae5; border-radius: 8px; padding: 8px; margin-top: 10px;">
                    <p style="font-size: 12px; color: #059669; margin: 0; font-weight: 600;">{'Excellent' if magic_number > 1.0 else 'Good' if magic_number > 0.75 else 'Needs improvement'} - Target: >1.0</p>
                </div>
            </div>
            
            <div style="background: white; border-radius: 14px; padding: 22px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                <h4 style="color: #1f2937; font-size: 16px; font-weight: 800; margin: 0 0 12px 0;">⚡ LTV:CAC Ratio</h4>
                <p style="font-size: 36px; color: #ec4899; font-weight: 900; margin: 0;">{ltv_cac:.1f}x</p>
                <p style="font-size: 13px; color: #6b7280; margin: 8px 0 0 0;">Customer economics</p>
                <div style="background: #fdf4ff; border-radius: 8px; padding: 8px; margin-top: 10px;">
                    <p style="font-size: 12px; color: #a855f7; margin: 0; font-weight: 600;">{'Strong' if ltv_cac >= 3 else 'Acceptable'} - Target: >3.0x</p>
                </div>
            </div>
        </div>
        
        <div style="background: white; border-radius: 14px; padding: 22px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
            <h4 style="color: #1f2937; font-size: 18px; font-weight: 800; margin: 0 0 15px 0;">🏢 Company Overview</h4>
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px;">
                <div style="background: #f0f9ff; border-radius: 8px; padding: 12px; text-align: center;">
                    <p style="font-size: 12px; color: #6b7280; margin: 0 0 4px 0;">Sector</p>
                    <p style="font-size: 16px; color: #3b82f6; font-weight: 800; margin: 0;">{startup['sector']}</p>
                </div>
                <div style="background: #fef3c7; border-radius: 8px; padding: 12px; text-align: center;">
                    <p style="font-size: 12px; color: #6b7280; margin: 0 0 4px 0;">Stage</p>
                    <p style="font-size: 16px; color: #f59e0b; font-weight: 800; margin: 0;">{startup['stage']}</p>
                </div>
                <div style="background: #d1fae5; border-radius: 8px; padding: 12px; text-align: center;">
                    <p style="font-size: 12px; color: #6b7280; margin: 0 0 4px 0;">Team</p>
                    <p style="font-size: 16px; color: #10b981; font-weight: 800; margin: 0;">{startup['team_size']} people</p>
                </div>
                <div style="background: #fdf4ff; border-radius: 8px; padding: 12px; text-align: center;">
                    <p style="font-size: 12px; color: #6b7280; margin: 0 0 4px 0;">Founded</p>
                    <p style="font-size: 16px; color: #a855f7; font-weight: 800; margin: 0;">{startup['founded']}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 3px solid #f59e0b; border-radius: 20px; padding: 28px; box-shadow: 0 8px 20px rgba(245, 158, 11, 0.2); margin-bottom: 25px;">
        <h3 style="color: #92400e; font-size: 26px; font-weight: 900; margin: 0 0 20px 0;">🤖 AI Investment Score Breakdown</h3>
    ...
    for metric, score in scores.items():
        ...
        <div style="background: white; border-radius: 12px; padding: 16px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <span style="font-size: 16px; color: #1f2937; font-weight: 700;">{metric}</span>
                <span style="font-size: 22px; color: {color}; font-weight: 900;">{score:.0f}</span>
            </div>
    ...
    scoring_html += f"""
        ...
        <div style="background: linear-gradient(135deg, {rec_color} 0%, {rec_color}dd 100%); border-radius: 12px; padding: 22px; margin-top: 20px; color: white; text-align: center;">
            <p style="font-size: 28px; font-weight: 900; margin: 0;">{rec_emoji} RECOMMENDATION: {recommendation}</p>
            <p style="font-size: 15px; margin: 10px 0 0 0; opacity: 0.95;">{'Exceptional opportunity - move fast to secure allocation' if recommendation == 'STRONG BUY' else 'Solid fundamentals - proceed with due diligence' if recommendation == 'BUY' else 'Monitor for next round' if recommendation == 'HOLD' else 'Focus resources on stronger opportunities'}</p>
        </div>
    </div>
    """
    ...
    <div style="background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border: 3px solid #10b981; border-radius: 20px; padding: 28px; box-shadow: 0 8px 20px rgba(16, 185, 129, 0.2); margin-bottom: 25px;">
        <h3 style="color: #065f46; font-size: 24px; font-weight: 900; margin: 0 0 18px 0;">💡 Investment Thesis</h3>
        
        <div style="background: white; border-radius: 14px; padding: 22px; margin-bottom: 15px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <h4 style="color: #10b981; font-size: 18px; font-weight: 800; margin: 0 0 12px 0;">✅ Key Strengths</h4>
            <ul style="margin: 0; padding-left: 24px; line-height: 2;">
                {''.join([f'<li style="color: #1f2937; font-size: 14px; font-weight: 600;">{s}</li>' for s in strengths])}
            </ul>
        </div>
        
        {f'''<div style="background: white; border-radius: 14px; padding: 22px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <h4 style="color: #f59e0b; font-size: 18px; font-weight: 800; margin: 0 0 12px 0;">⚠️ Areas to Monitor</h4>
            <ul style="margin: 0; padding-left: 24px; line-height: 2;">
                {''.join([f'<li style="color: #1f2937; font-size: 14px; font-weight: 600;">{c}</li>' for c in concerns])}
            </ul>
        </div>''' if concerns else ''}
    </div>
    """
    ...
    return summary_html + metrics_html + scoring_html + thesis_html, fig_radar, fig_revenue
...
def generate_portfolio_dashboard():
    ...
    dashboard_html = f"""
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; padding: 32px; box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3); margin-bottom: 25px;">
        <h2 style="color: white; font-size: 32px; font-weight: 900; margin: 0 0 20px 0;">📊 Portfolio Performance</h2>
        
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Portfolio Companies</p>
                <p style="font-size: 48px; color: white; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">{len(SAMPLE_STARTUPS)}</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Active investments</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Total AUM</p>
                <p style="font-size: 48px; color: #86efac; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">$180M</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Under management</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">Avg Growth</p>
                <p style="font-size: 48px; color: white; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">184%</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">YoY across portfolio</p>
            </div>
            
            <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 22px; text-align: center; border: 2px solid rgba(255,255,255,0.2);">
                <p style="font-size: 14px; color: rgba(255,255,255,0.8); margin: 0 0 10px 0; font-weight: 600;">IRR</p>
                <p style="font-size: 48px; color: #fbbf24; font-weight: 900; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">47%</p>
                <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 8px 0 0 0;">Internal return rate</p>
            </div>
        </div>
    </div>
    """
    ...
    <div style="background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%); border: 3px solid #a855f7; border-radius: 20px; padding: 28px; box-shadow: 0 8px 20px rgba(168, 85, 247, 0.2); margin-bottom: 25px;">
        <h3 style="color: #6b21a8; font-size: 26px; font-weight: 900; margin: 0 0 20px 0;">🏢 Portfolio Companies</h3>
    ...
    for idx, (name, data) in enumerate(SAMPLE_STARTUPS.items()):
        ...
        <div style="background: white; border-left: 5px solid {color}; border-radius: 12px; padding: 20px; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                <div>
                    <p style="font-size: 18px; color: #1f2937; font-weight: 800; margin: 0 0 4px 0;">{name}</p>
                    <p style="font-size: 13px; color: #6b7280; margin: 0;">{data['sector']} • {data['stage']}</p>
                </div>
                <div style="text-align: right;">
                    <p style="font-size: 24px; color: {color}; font-weight: 900; margin: 0;">{data['score']}</p>
                    <p style="font-size: 12px; color: #6b7280; margin: 4px 0 0 0;">AI Score</p>
                </div>
            </div>
            
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 12px;">
                <div style="background: #f9fafb; border-radius: 6px; padding: 8px; text-align: center;">
                    <p style="font-size: 11px; color: #6b7280; margin: 0;">ARR</p>
                    <p style="font-size: 16px; color: #1f2937; font-weight: 700; margin: 4px 0 0 0;">${data['arr']:.1f}M</p>
                </div>
                <div style="background: #f9fafb; border-radius: 6px; padding: 8px; text-align: center;">
                    <p style="font-size: 11px; color: #6b7280; margin: 0;">Growth</p>
                    <p style="font-size: 16px; color: #10b981; font-weight: 700; margin: 4px 0 0 0;">{data['growth_rate']}%</p>
                </div>
                <div style="background: #f9fafb; border-radius: 6px; padding: 8px; text-align: center;">
                    <p style="font-size: 11px; color: #6b7280; margin: 0;">Runway</p>
                    <p style="font-size: 16px; color: #3b82f6; font-weight: 700; margin: 4px 0 0 0;">{data['runway']}m</p>
                </div>
            </div>
        </div>
        """
    ...
    return dashboard_html + portfolio_html, fig_sector, fig_scatter
...
with gr.Blocks(css=custom_css, theme=gr.themes.Soft()) as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🎯 Analyze Startup"):
            ...
            startup_dropdown = gr.Dropdown(
                choices=list(SAMPLE_STARTUPS.keys()),
                value="FinTech Platform",
                label="Select Startup to Analyze"
            )
            
            analyze_btn = gr.Button("📊 Analyze Investment Opportunity", variant="primary", size="lg")
            
            analysis_output = gr.HTML(label="Investment Analysis")
            radar_chart = gr.Plot(label="Score Breakdown")
            revenue_chart = gr.Plot(label="Revenue Projection")
            
            analyze_btn.click(
                fn=analyze_startup,
                inputs=[startup_dropdown],
                outputs=[analysis_output, radar_chart, revenue_chart]
            )
        ...
        with gr.Tab("📊 Portfolio Dashboard"):
            ...
            portfolio_btn = gr.Button("📊 Load Portfolio Dashboard", variant="primary", size="lg")
            
            portfolio_output = gr.HTML(label="Portfolio Overview")
            sector_chart = gr.Plot(label="Sector Distribution")
            performance_chart = gr.Plot(label="Performance Matrix")
            
            portfolio_btn.click(
                fn=generate_portfolio_dashboard,
                inputs=[],
                outputs=[portfolio_output, sector_chart, performance_chart]
            )
    ...
    <div style="text-align: center; padding: 40px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; box-shadow: 0 12px 28px rgba(102, 126, 234, 0.35); color: white;">
        ...
        <p style="font-size: 15px; margin: 18px 0; font-weight: 700;">
            <strong style="color: white;">Tech Stack:</strong> Python • Gradio • Plotly • Financial Analytics • ML Scoring
        </p>
