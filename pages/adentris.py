...
<div style="text-align: center; margin-bottom: 25px;">
    <p style="font-size: 28px; color: #667eea; font-weight: 700; margin: 15px 0;">AI Healthcare Compliance Intelligence</p>
    <p style="font-size: 18px; color: #6b7280; font-weight: 500; margin-bottom: 25px;">Automated compliance checking for hospitals & healthcare organizations</p>
</div>
""", unsafe_allow_html=True)
...
with col1:
    st.markdown('<span style="background: linear-gradient(135deg, #ec4899 0%, #f43f5e 100%); color: white; padding: 10px 22px; border-radius: 30px; font-size: 15px; font-weight: 800; display: block; text-align: center;">HIPAA</span>', unsafe_allow_html=True)
with col2:
    st.markdown('<span style="background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: white; padding: 10px 22px; border-radius: 30px; font-size: 15px; font-weight: 800; display: block; text-align: center;">CMS</span>', unsafe_allow_html=True)
with col3:
    st.markdown('<span style="background: linear-gradient(135deg, #f59e0b 0%, #ea580c 100%); color: white; padding: 10px 22px; border-radius: 30px; font-size: 15px; font-weight: 800; display: block; text-align: center;">Joint Commission</span>', unsafe_allow_html=True)
with col4:
    st.markdown('<span style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 10px 22px; border-radius: 30px; font-size: 15px; font-weight: 800; display: block; text-align: center;">YC Backed</span>', unsafe_allow_html=True)

st.markdown("""
<p style="text-align: center; font-size: 16px; color: #6b7280; margin-top: 25px; font-weight: 600;">
    Built for <strong style="color: #667eea;">Adentris</strong> by <strong style="color: #667eea;">Anju Nandhakumar</strong>
</p>
""", unsafe_allow_html=True)
